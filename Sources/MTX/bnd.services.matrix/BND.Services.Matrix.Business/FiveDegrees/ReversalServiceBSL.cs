...
namespace BND.Services.Matrix.Business.FiveDegrees.ReversalService
{
    // 
    ...
    public partial class ReversalServiceBSL : WebServicesClientProtocolExtended
    {
        ...
        {
            this.Url = ConfigurationManager.AppSettings[Constants.MatrixReversalServiceBaseUrl] + "/Service.svc";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://service.matrix.financials.fivedegrees.nl/1.0/IReversalService/Reversible",
            RequestNamespace = "http://service.matrix.financials.fivedegrees.nl/1.0", ResponseNamespace = "http://service.matrix.financials.fivedegrees.nl/1.0",
            Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable = true)]
        public OperationResult_ReversibleItem Reversible(
            string correlationId,
            int centerId,
            [System.Xml.Serialization.XmlIgnoreAttribute()] bool centerIdSpecified,
            long operationId,
            [System.Xml.Serialization.XmlIgnoreAttribute()] bool operationIdSpecified)
        {
            object[] results = this.Invoke("Reversible", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified });
            return ((OperationResult_ReversibleItem)(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginReversible(
            string correlationId,
            int centerId,
            bool centerIdSpecified,
            long operationId,
            bool operationIdSpecified,
            System.AsyncCallback callback,
            object asyncState)
        {
            return this.BeginInvoke("Reversible", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified }, callback, asyncState);
        }
        ...
        public void ReversibleAsync(string correlationId, int centerId, bool centerIdSpecified, long operationId, bool operationIdSpecified, object userState)
        {
            ...
            this.InvokeAsync("Reversible", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified }, this.ReversibleOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://service.matrix.financials.fivedegrees.nl/1.0/IReversalService/Revert",
            RequestNamespace = "http://service.matrix.financials.fivedegrees.nl/1.0", ResponseNamespace = "http://service.matrix.financials.fivedegrees.nl/1.0",
            Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable = true)]
        public OperationResult_ReversalResultItem Revert(
            string correlationId,
            int centerId,
            [System.Xml.Serialization.XmlIgnoreAttribute()] bool centerIdSpecified,
            long operationId,
            [System.Xml.Serialization.XmlIgnoreAttribute()] bool operationIdSpecified)
        {
            object[] results = this.Invoke("Revert", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified });
            return ((OperationResult_ReversalResultItem)(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginRevert(
            string correlationId,
            int centerId,
            bool centerIdSpecified,
            long operationId,
            ...
            object asyncState)
        {
            return this.BeginInvoke("Revert", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified }, callback, asyncState);
        }
        ...
        public void RevertAsync(string correlationId, int centerId, bool centerIdSpecified, long operationId, bool operationIdSpecified, object userState)
        {
            ...
            this.InvokeAsync("Revert", new object[] { correlationId, centerId, centerIdSpecified, operationId, operationIdSpecified }, this.RevertOperationCompleted, userState);
        }
