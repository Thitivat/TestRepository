...
namespace BND.Services.IbanStore.Repository.Ef
{
    public abstract class EfUnitOfWorkBase : IEfUnitOfWork
    {
        #region [Fields]
        ...
        public virtual IEnumerable<TResult> ExecuteReader<TResult>(string nameOrSqlScript, Dictionary<string, object> parameters = null)
            where TResult : class
        {
            DbParameter[] dbParameters = SetDbCommandParameters(parameters);
            var data = _context.Database.SqlQuery<TResult>(nameOrSqlScript, dbParameters).AsEnumerable();
            return data;
        }
        ...
        /// </summary>
        /// <param name="nameOrSqlScript">Name of the store procedure.</param>
        /// <param name="parameters">The parameters of store procedure.</param>
        /// <returns>System.Int32.</returns>
        /// <exception cref="System.ObjectDisposedException"></exception>
        /// <exception cref="System.ArgumentNullException">storeProcedureName</exception>
        public virtual int ExecuteNonQuery(string nameOrSqlScript, Dictionary<string, object> parameters = null)
        {
            // setting parameters.
            DbParameter[] dbParameters = SetDbCommandParameters(parameters);

            int result=_context.Database.ExecuteSqlCommand(nameOrSqlScript, dbParameters);
            return result;
        
        }

        /// <summary>
        /// Setting up parameters for field.
        /// </summary>
        /// <param name="nameOrSqlScript">Name of the store procedure.</param>
        /// <param name="parameters">The parameters.</param>
        /// <exception cref="System.ArgumentNullException">storeProcedureName</exception>
        protected DbParameter[] SetDbCommandParameters(Dictionary<string, object> parameters)
        {
