...
{
    /// <summary>
    /// Abstract class EfUnitOfWorkBase implementing <see cref="BND.Services.Security.OTP.Repositories.Interfaces.IUnitOfWork"/> interface
    ...
    /// This component has to use with <see cref="BND.Services.Security.OTP.Repositories.Ef.EfRepository&lt;TPocoEntity&gt;"/> class.
    /// </summary>
    /// <example>
    /// The following example demonstrates how to use the
    /// <see cref="BND.Services.Security.OTP.Repositories.Ef.EfUnitOfWorkBase"/> abstract class to create a unit of work class.
    /// 
    /// <code>
    /// using System.Data.Entity;
    ...
    /// // database context representing database that inherited from <see>
    ///         <cref>System.Data.Entity.Dbcontext</cref>
    ///     </see>  class.
