...
namespace BND.Services.Security.OTP.Repositories.Ef
{
    ...
    /// <see cref="BND.Services.Security.OTP.Repositories.Interfaces.IRepository&lt;TPocoEntity&gt;"/> interface
    ...
    /// <see cref="BND.Services.Security.OTP.Repositories.Ef.EfUnitOfWorkBase"/> abstract class following unit of work pattern.
    /// </remarks>
    /// <example>
    /// The following example demonstrates how to use the
    /// <see cref="BND.Services.Security.OTP.Repositories.Ef.EfRepository&lt;TPocoEntity&gt;"/> class
        ...
        where TPocoEntity : class
    {
        ...
        /// </summary>
        protected DbSet<TPocoEntity> DbSet;
        ...
        public virtual IQueryable<TPocoEntity> GetQueryable(
            ...
            params string[] includeProperties)
        {
            IQueryable<TPocoEntity> result = DbSet;
            ...
            if (page != null)
            {
                ...
                {
                    throw new ArgumentException("page.OrderBy");
                }
        ...
        {
            DbEntityEntry entry = Context.Entry(entityToInsert);
        ...
        {
            DbEntityEntry entry = Context.Entry(entityToUpdate);
            if (entry.State == EntityState.Detached)
            {
        ...
        {
            DbEntityEntry entry = Context.Entry(entityToDelete);
