...
using BND.Services.Security.OTP.ClientProxy.NET4.Interfaces;
...
namespace BND.Services.Security.OTP.ClientProxy.NET4
{
    /// <summary>
    ...
    /// <seealso cref="BND.Services.Security.OTP.ClientProxy.NET4.Interfaces.IOneTimePasswords"/> interface.
    /// </summary>
    public class OneTimePasswords : ResourceBase, IOneTimePasswords
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BND.Services.Security.OTP.ClientProxy.NET4.OneTimePasswords"/> class.
        /// </summary>
