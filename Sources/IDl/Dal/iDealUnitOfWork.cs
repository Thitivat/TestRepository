...
namespace BND.Services.Payments.iDeal.Dal
{
    ...
    /// </code>
    /// </example>
    public class iDealUnitOfWork : EfUnitOfWorkBase
    {
        ...
        public iDealUnitOfWork(string connectionString, bool checkDbExists = true)
            : base(new iDealDbContext(new SqlConnection(connectionString)),
