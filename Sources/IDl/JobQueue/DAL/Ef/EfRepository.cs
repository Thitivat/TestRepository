...
namespace BND.Services.Payments.iDeal.JobQueue.Dal.Ef
{
    /// <summary>
    /// Class EfRepository provides generic repository that use for any repository which implements
        ...
        where TPocoEntity : class
    {
        ...
        public virtual int GetCount(Expression<Func<TPocoEntity, bool>> filter = null)
        {
